...
- O ```$ sudo docker run --name nome_DB -e POSTGRES_PASSWORD=senha -e POSTGRES_DB=banco de dados -p 5432:5432 -d postgres:12.2``` irá criar uma insrância do Postgres configurando porta, nome e senha de um DB Potgres;
